...
public class NotificationServiceImplTest {
	...
	public void shouldSendBackupNotificationsEvenWhenErrorsOccursForSomeRecipients() throws IOException, MessagingException, InterruptedException {
		...
		verify(emailService, timeout(1000)).send(NotificationType.BACKUP, withNoError, attachment);
		verify(recipientService, timeout(1000)).markNotified(NotificationType.BACKUP, withNoError);
